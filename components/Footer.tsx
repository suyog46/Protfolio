  ...
  return (
    <footer className="bg-gray-900 text-white py-8">
      <div className="container mx-auto text-center space-y-6">
        ...
        {/* Footer Links */}
        <div className="mb-4">
          <a href="#home" className="mx-3 text-gray-400 hover:text-white transition">Home</a>
          <a href="#about" className="mx-3 text-gray-400 hover:text-white transition">About Me</a>
          <a href="#services" className="mx-3 text-gray-400 hover:text-white transition">Services</a>
          <a href="#work" className="mx-3 text-gray-400 hover:text-white transition">Work</a>
